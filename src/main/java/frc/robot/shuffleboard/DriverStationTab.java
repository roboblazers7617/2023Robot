...
public class DriverStationTab extends ShuffleboardTabBase {
    ...
    public DriverStationTab(Drivetrain drivetrain, Intake intake) {
        ...
        // autoPath.setDefaultOption("Blue Right Node",
        // DrivetrainConstants.AutoPath.blueNodeOne);
        // autoPath.addOption("Blue Mid Node",
        // DrivetrainConstants.AutoPath.blueNodeSix);
        // autoPath.addOption("Blue Left Node",
        // DrivetrainConstants.AutoPath.blueNodeNine);
        ...
        // autoPath.addOption("Red Right Node",
        // DrivetrainConstants.AutoPath.redNodeNine);
        // autoPath.setDefaultOption("high cone score left blue simple",
        // DrivetrainConstants.AutoPath.leftBlueSimple);
        // autoPath.addOption("high cone score mid blue simple",
        // DrivetrainConstants.AutoPath.midBlueSimple);
        // autoPath.addOption("high cone score right blue simple",
        // DrivetrainConstants.AutoPath.rightBlueSimple);
        // autoPath.addOption("high cone scoreleft red simple",
        // DrivetrainConstants.AutoPath.leftRedSimple);
        // autoPath.addOption("high cone score mid red simple",
        // DrivetrainConstants.AutoPath.midRedSimple);
        // autoPath.addOption("high cone score right red simple",
        // DrivetrainConstants.AutoPath.rightRedSimple);
