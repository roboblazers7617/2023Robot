...
public class AutonMoveToScore extends SequentialCommandGroup {
  /** Creates a new SimpleMoveArmToPosition. */
  public AutonMoveToScore(Arm arm, Wrist wrist, Supplier<ScoreLevel> level, Supplier<PieceType> piece) {
