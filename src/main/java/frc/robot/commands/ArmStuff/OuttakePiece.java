...
public class OuttakePiece extends CommandBase {
  ...
  public OuttakePiece(Intake intake, armIntakeCordinatorUtil cordinatorUtil) {
  ...
  public void initialize() {
    if(mCordinatorUtil.getDesiredOrHeldPiece() == PieceType.CONE)
      mIntake.setIntakeSpeed(IntakeDirection.PlaceCone.speed());
    if(mCordinatorUtil.getDesiredOrHeldPiece() == PieceType.CUBE)
      mIntake.setIntakeSpeed(IntakeDirection.PlaceCube.speed());
